...
export const popupOpenChangeAvatar = document.querySelector('.profile__edit-button_avatar')
...
export const buttonEditAvatar = document.querySelector('.profile__edit-button_avatar');
